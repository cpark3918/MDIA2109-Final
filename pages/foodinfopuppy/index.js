...
const FoodInfoPuppy = ({ backgroundColor}) => <div
    ...
    <div className="defaultscreen">
        ...
        <div className="foodinfoPanel">
            <InfoPanel title="Food" info="It is important to feed your puppy food that is specially formulated for puppies. Adult dog food lacks the nutrients puppies need to develop.  
